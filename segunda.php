...
<div class="content">
	<div class="container">
      ...
      $q ="SELECT * FROM eletronicos where id=$a ";
...
<?php 
	...
	<?php 
      ...
      $q ="SELECT * FROM eletronicos where id=$b";
...
<?php 
     ...
     ?>
      ...
      $q ="SELECT * FROM eletronicos where id=$c";
 ...
 ?>	<div class="col-md-4 women-grids wp3 animated wow slideInUp" data-wow-delay=".5s">
     ...
     ?>
      ...
      $q ="SELECT * FROM eletronicos where id=$d";
 ...
 ?>
     ...
     ?><?php 
      ...
      $q ="SELECT * FROM eletronicos where id=$e";
 ...
 ?>
     ...
     ?>
      ...
      $q ="SELECT * FROM eletronicos where id=$f";
 ...
 ?>	
     ...
     ?>
      ...
      $q ="SELECT * FROM eletronicos where id=$g";
 ...
 ?>
     ...
     ?>
      ...
      $q ="SELECT * FROM eletronicos where id=$h";
...
<?php 
      ...
      $q ="SELECT * FROM eletronicos where id=$i";
