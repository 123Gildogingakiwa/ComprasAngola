				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="newspro.php">Eletronicos</a></li>
								<li><a href="women.php">Para Mulheres</a></li>
								<li><a href="men.php">Para Homens</a></li>
								<li><a href="kids.php">Para Crianças</a></li>
								<li><a href="deos.php">Perfumes</a></li>
							</ul>
						</div>
					</div>
			</div>
