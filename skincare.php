				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="haircare.html">Hair oils</a></li>
								<li><a href="haircare.html">Conditioners</a></li>
								<li><a href="haircare.html">Shampoos</a></li>
								<li><a href="haircare.html">Hair boosters</a></li>
							</ul>
						</div>
					</div>
			</div>
			<div class="w3ls_dresses_grid_left_grid">
				...
				<div class="w3ls_dresses_grid_left_grid_sub">
					<div class="ecommerce_color">
						<ul>
							<li><a href="haircare.html">Olive</a></li>
							<li><a href="haircare.html">Coconut</a></li>
							<li><a href="haircare.html">Strawberry</a></li>
							<li><a href="haircare.html">Ginger</a></li>
						</ul>
					</div>
				</div>
			</div>
