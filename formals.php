				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="formals.html">Casuals</a></li>
								<li><a href="formals.html">Slacks</a></li>
								<li><a href="formals.html">Jeans</a></li>
								<li><a href="formals.html">Shirts</a></li>
							</ul>
						</div>
					</div>
			</div>
